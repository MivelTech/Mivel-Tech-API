...
```bash
curl -X POST "https://miviel.onrender.com/api/generate-code" \
...
Maviel's code generation follows these principles:
...
```javascript
const response = await fetch('https://miviel.onrender.com/api/generate-code', {
  method: 'POST',
