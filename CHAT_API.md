...
The Chat API allows you to have natural conversations with Maviel AI assistant.

## Endpoints

### POST /api/chat

Send a message to Maviel and receive a conversational response with context awareness.
...
|-----------|------|----------|-------------|
| message | string | Yes | The user's message to send to Maviel |
...
```json
{
  "response": "I'm Maviel, a friendly and intelligent AI companion created by talented developers who wanted to make AI assistance more personal and friendly. I'm here to help you with various tasks, answer questions, or just have a nice conversation!",
  "usage": {
    "prompt_tokens": 45,
...
|-------|------|-------------|
| response | string | Maviel's response message |
...
Maviel uses the following personality traits:
...
```javascript
const response = await fetch('https://miviel.onrender.com/api/chat', {
  method: 'POST',
